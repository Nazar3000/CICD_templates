...
class SubscriptionView(ReadOnlyModelViewSet):
    queryset = (
        ...
        .prefetch_related("plan", Prefetch("client", queryset=Client.objects.all().select_related("user").only("company_name", "user__email")))
    ...
    def list(self, request, *args, **kwargs):
        ...
        response_data = {"resoult": response.data}
